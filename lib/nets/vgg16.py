...
class vgg16(Network):
    ...
    def build_network(self, sess, is_training=True):
        with tf.variable_scope('vgg_16', 'vgg_16'):
            ...
            # Build head
            avg_net, net4, net = self.build_head(is_training)
            ...
            self._predictions["avg_net"] = avg_net
            self._predictions["net4"] = net4
    ...
    def build_head(self, is_training):
        ...
        net4 = slim.max_pool2d(net, [2, 2], padding='SAME', scope='pool4')

        # Layer 5
        net = slim.repeat(net4, 3, slim.conv2d, 512, [3, 3], trainable=is_training, scope='conv5')
